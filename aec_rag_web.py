# aec_rag_web_fixed.py - Completely Fixed Web Interface
...
class AECRAG:
    ...
    def check_ollama_connection(self):
        ...
        try:
            ...
            if not any(self.embedding_model in m for m in available_models):
                print(f"⚠️ Embedding model '{self.embedding_model}' not found")
                print("📌 Pulling model...")
                self.pull_model(self.embedding_model)
            
            if not any(self.chat_model in m for m in available_models):
    ...
    def generate_sample_data(self, num_projects=50):
        ...
        for i in range(1, num_projects + 1):
            ...
            project = {
                ...
                'description': f"This project involves {random.choice(['structural improvements', 'system upgrades', 'capacity expansion'])}",
    ...
    def generate_response(self, question, relevant_docs):
        ...
        if not relevant_docs:
            return "No relevant projects found for your question. Please try rephrasing."
        
        context = "Here are the most relevant projects:\n\n"
...
Answer:"""
        ...
        try:
            response = ollama.chat(
                ...
                messages=[
                    {"role": "system", "content": "You are a helpful project management assistant. Only use the provided project information."},
